import { existsSync, statSync, readdirSync, writeFileSync, unlinkSync } from 'fs';
...
import {
  ...
  verifyToken, generateToken, isAuthenticated,
...
export async function handleRequest(req, res) {
  ...
  if (pathname === '/login') {
    ...
    res.end(loginPage.replace(/\{\{NONCE\}\}/g, nonce));
    return;
  }
